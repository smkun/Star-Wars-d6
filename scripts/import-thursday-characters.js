/**
 * Import 6 new characters from Thursday.txt to MySQL database
...
const characters = [
  {
    name: 'F1X 3R',
    species_slug: null, // FX Series Droid - no species entry
  ...
  {
    name: 'Dakk',
    species_slug: null, // Human - no slug needed (or use 'human' if you have it)
  ...
  try {
    ...
    for (const char of characters) {
      ...
      try {
        ...
        console.log(`✅ Inserted: ${char.name} (${id})`);
        inserted++;
      } catch (err) {
