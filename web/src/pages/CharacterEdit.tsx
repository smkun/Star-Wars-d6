...
import type { Character, CharacterData, AttributeBlock, Skill } from '@/types/character.types';
    ...
    <div className="min-h-screen bg-gray-900 text-yellow-400">
      <header className="border-b-2 border-yellow-400 bg-gray-950">
        <div className="max-w-7xl mx-auto px-8 py-8 flex items-center justify-between">
          <div>
            <Link to={`/characters/${id}`} className="text-yellow-400 hover:underline mb-2 block">
              ← Back to Character
            </Link>
            <h1 className="text-4xl font-bold">Edit: {char.name}</h1>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-8 py-12">
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <section className="bg-gray-800 border-2 border-yellow-400/20 rounded p-6">
            ...
            {data.forceSensitive && (
              <>
                <h3 className="text-xl font-bold mb-4 text-yellow-400">Force Attributes</h3>
